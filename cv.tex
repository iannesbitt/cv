...
{Muddy Waters Initiative}
{Boston, MA, USA}
{}
{
    \emph{Duties}: Processed, performed QA/QC on, designed
    presentation-quality maps from, and formatted geospatial
    data for submission to the Massachusetts Department
    of Conservation and Recreation (DCR) for \caroline.
}
