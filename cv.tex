...
{}
{
    \emph{Duties}: Processing ground-penetrating radar (GPR) survey data
    from the Hudson Mountains in collaboration with \johnwoodward,
    \joannejohnson, \brent, and \seth.
}
